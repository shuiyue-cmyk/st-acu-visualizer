(function () {
    ...
    const EXT_VERSION = '17.3.15'; // 与 manifest.json version 同步
    ...
    const addStyles = () => {
        ...
        const styles = `
            ...
            .acu-embedded-dashboard-container .acu-dash-container { gap: 0 !important; padding: 0 !important; }
                ...
                /* 滚动模式长度对齐仪表盘/选项并略长：随末楼滚动时视觉与嵌入式仪表盘同宽，左右各扩 6px */
                .acu-wrapper.acu-tt-scroll { width: calc(100% + 12px) !important; margin-left: -6px !important; margin-right: -6px !important; }
            </style>
        `;
        $('head').append(styles);
    };
